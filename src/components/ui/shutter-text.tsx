...
export default function ShutterText({
  ...
  trigger = "auto",
  className = "",
  textClassName = "font-heading font-bold text-foreground leading-none tracking-tight",
            ...
            {characters.map((char, i) => (
              ...
              >
                ...
                <motion.span
                  ...
                  className={`pointer-events-none absolute inset-0 z-10 inline-block font-bold leading-none ${sliceClassName}`}
                ...
                <motion.span
                  ...
                  className={`pointer-events-none absolute inset-0 z-10 inline-block font-bold text-foreground/80 leading-none`}
                  style={{
